      ...
      {stats.map((stat, index) => (
        ...
        >
          <div className="flex items-start justify-between">
            ...
            <div
              className={`${stat.bgColor} p-3 rounded-xl group-hover:scale-110 transition-all duration-200`}
            >
          ...
          <div className="mt-4 h-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
            <div
              className={`h-full bg-linear-to-r rounded-full transition-all duration-100 ${stat.color}`}

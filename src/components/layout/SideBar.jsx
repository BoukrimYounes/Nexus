...
function SideBar({ collapsed, onToggle, currentPage, onPageChange }) {
  ...
  return (
    ...
    >
      {/* logo */}
      <div className="p-5 border-b border-slate-200/20 dark:border-slate-700/50">
        <div className="flex items-center space-x-3">
          <div className="min-w-11 h-11 bg-linear-to-r from-blue-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg">
      ...
      {!collapsed && (
        <div className="p-4 border-t border-slate-200/50 dark:border-slate-slate-700/50">
          <div className="bg-slate-50 flex items-center space-x-3 p-3 rounded-xl  dark:bg-slate-800/50">
            <img
